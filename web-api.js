(function () {
  ...
  window.accountDB = {
    ...
    superLogin: (id, password) => request("/api/superuser/login", { method: "POST", body: JSON.stringify({ id, password }) }),
    superAccounts: () => request("/api/superuser/accounts"),
    superDeleteAccount: (id) => request(`/api/superuser/accounts/${id}`, { method: "DELETE", body: "{}" }),
